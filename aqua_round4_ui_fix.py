...
def aqua_round6_user_fixes_js():
    return app_v3.send_from_directory(".", "aqua-round6-user-fixes.js", mimetype="application/javascript", max_age=0)
...
def inject_aqua_round4_ui(response):
    try:
        ...
        if '/aqua-round6-user-fixes.js?' not in body:
            body = body.replace(
                "</body>",
                '<script src="/aqua-round6-user-fixes.js?v=20260902-1"></script></body>',
                1,
            )
