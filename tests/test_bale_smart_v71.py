...
def test_bale_finalize_links_existing_smart_service():
 b=src("bale_bridge.py"); assert "/api/bale/jobs/<job_id>/finalize" in b and "service_visit_id" in b and "smart_finalize" in b
...
def test_v8_assets():
 i=src("index.html"); assert "AquaGold CRM v8" in i and "/bale-ui.js?v=" in i and "/aria-v8.js?v=" in i
