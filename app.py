...
# CSS-only guard registers first so Flask's reverse after_request order emits its
# compact iPhone overrides after the existing Map/Navigation guard.
import aqua_map_compact_css_guard  # noqa: E402,F401
